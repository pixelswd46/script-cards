    ...
    return (
        ...
        <div className="my-18 px-14 w-full md:w-1/2 lg:my-24 lg:px-14 lg:w-1/3">
            <article className="py-26 px-20 rounded-lg custom-shadow cursor-pointer">
                ...
                <h3 className="text-left text-32 font-semibold text-black mt-26">{item?.price} <sub className='text-16 text-gray-500 font-normal relative bottom-1'>{item?.package_time}</sub> </h3>
